...
arrives. Define the repository configuration, model, and instructions once, then OpenOutposts starts
...
4. OpenOutposts prepends a webhook context block to your automation instructions and starts a new
...
For each accepted request, OpenOutposts prepends a context block to your instructions that includes:
...
When present, OpenOutposts uses that value to deduplicate repeated deliveries of the same logical
