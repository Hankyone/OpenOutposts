...
/**
 * Default port code-server binds to. Inherited from the in-sandbox runtime,
 * which is gone; port exposure on a machine the user owns is its own decision
 * and is not carried forward.
 */
export const DEFAULT_CODE_SERVER_PORT = 8080;

/**
 * Default port the web terminal (ttyd) proxy was exposed on. Inherited; see
