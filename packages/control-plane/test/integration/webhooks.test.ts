...
import { encryptSentrySecret } from "../../src/auth/webhook-key";
...
async function createSentryAutomation(
  ...
  // Sealed to this automation, exactly as the route does — a secret encrypted
  // for a different automation would not verify its deliveries.
  automation.trigger_auth_data = await encryptSentrySecret(
    SENTRY_TEST_SECRET,
