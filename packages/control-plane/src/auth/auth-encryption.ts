...
const HKDF_SALT = "openoutposts/auth-key-derivation/v1";
const V1_PURPOSE_INFO: Readonly<Record<AuthEncryptionPurpose, string>> = {
  provider_credentials: "openoutposts/provider-credentials/v1",
  provider_pkce_flow: "openoutposts/provider-pkce-flow/v1",
};
