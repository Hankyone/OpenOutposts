...
describe("createSessionInternalRoutes", () => {
  it("builds the expected method/path mapping", () => {
    const routes = createSessionInternalRoutes({
      ...
      rotateSandboxCredentials: noopHandler(),
      startupFailure: noopHandler(),
    ...
    expect(methodPathSet).toEqual(
      new Set([
        ...
        `POST ${SessionInternalPaths.rotateSandboxCredentials}`,
        `POST ${SessionInternalPaths.startupFailure}`,
