 ...
 * repository list ([0] = primary) with a per-repository base branch.
 * Repositories keep their selection order; rows can be reordered so any
 * repository can become the primary (the workspace/settings source).
 */
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-1 leading-normal">
          ...
          it provides the workspace and editor settings.
        </p>
      </div>
